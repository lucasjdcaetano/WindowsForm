namespace Views {
    public class ListaEstoque : Form {
        ...
        public void ListRefresh() {
            ...
            foreach(Models.Estoque p in Models.Estoque.Estoques) {
                listView.Items.Add(
                    new ListViewItem(new [] {
                        p.Id.ToString(), p.Nome.ToString()
                    }) 
                );    
            }
        }
        ...
        public void Alterar_Click(object sender, EventArgs e) {
            if (listView.SelectedItems.Count > 0) {
                ...
                Models.Estoque estoque = Models.Estoque.Estoques.Find(p => p.Id == id);
                new AlterarEstoque(estoque);
                this.ListRefresh();
            } else {
